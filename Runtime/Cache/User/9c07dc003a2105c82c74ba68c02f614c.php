...
<head>
<meta charset="utf-8"/>
<title><?php if(empty($pageTitle)): echo S('SITE_ADMIN_TITLE');?>
        <?php else: ?>
        <?php echo ($_pageTitle); ?> - <?php echo S('SITE_ADMIN_TITLE'); endif; ?></title> 
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        ...
        <div class="page-top">
            ...
            <!-- END PAGE TOP --> </div>
        <!-- END HEADER INNER --> </div><!-- END HEADER -->
<div class="clearfix">
</div>
<!-- BEGIN CONTAINER -->
...
<!-- BEGIN PAGE LEVEL SCRIPTS -->
	...
	<!-- bootstrap-datetimepicker.min.js日期控件 -->
	...
	<!-- bootstrap-select.min.js下拉菜单美化插件 -->
	...
	<script type="text/javascript">
	     window.FileAPI = {staticPath: _PUBLIC_+'/assets/global/plugins/jquery-fileapi/FileAPI/'};
	</script>
